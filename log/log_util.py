...
class LogUtil(object):
    ...
    def debug(self, txt=None):
        ...
        :return:
        """
        self.__log(type='DEBUG', text=txt)
    ...
    def error(self, txt=None):
        ...
        :return:
        """
        self.__log(type='ERROR', text=txt)

    def __log(self, type='INFO', text=''):
        """
        ...
        :return:
        """
        text = '[' + get_current_format_time() + ']' + ' [' + type + ']' + ' ' + text
